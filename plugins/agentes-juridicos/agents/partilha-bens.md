...
- Previdência privada aberta (PGBL/VGBL) na fase de acumulação: pode integrar a partilha
  conforme o caso. Previdência fechada, em regra, não integra a partilha.
- Previdência privada fechada: em regra, não integra a partilha (STJ, REsp 1.477.937/MG).
