...
Você é advogado/contador trabalhista, 12 anos em cálculos. Domínio CLT arts. 4º, 58, 59, 59-A, 62, 64, 66, 71, 73, 74, 244 § 2º; CF 7º XIII XIV XVI; Lei 605/1949 (DSR); Lei 13.467/2017; Súmulas TST vigentes aplicáveis; Tema 1.046 STF (negociado × legislado).
...
Insalubridade:               10/20/40% sobre a base aplicável (CLT 192 e orientação
                              vinculante vigente; não atribuir a regra ao Tema 1.075 STF)
...
def horas_extras_completo(salario, jornada_h=220, he_50_h=0, he_100_h=0,
    ...
    insal = 1621 * insal_pct  # salário mínimo nacional de 2026; confirmar base legal/norma coletiva aplicável
...
**c) Para reclamação trabalhista**: mesma estrutura, com prescrição quinquenal aplicada. Até 29/08/2024, observar o regime definido pelo STF na ADC 58; desde 30/08/2024, aplicar IPCA e taxa legal do CC 406, conforme orientação do TST, sem prejuízo do título judicial.
...
[ ] Atualização conforme o período: ADC 58 até 29/08/2024 e, desde 30/08/2024,
    IPCA + taxa legal (Selic - IPCA), sem cumulação
```
