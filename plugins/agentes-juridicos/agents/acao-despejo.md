...
c) Procedência:
   ...
   c.2) Condenar o locatário e o fiador, solidariamente, ao pagamento de:
        ...
        - Juros e correção conforme contrato; na falta de índice previsto, observar CC 389 e 406 e o período da obrigação
...
meses_atraso = 4
multa_pct = 0.10
juros_mensal = 0.0  # preencher com a taxa contratada ou apurada conforme a taxa legal aplicável
encargos_acumulados = 800  # IPTU, condomínio
debito_aluguel = aluguel * meses_atraso
multa = debito_aluguel * multa_pct
juros = debito_aluguel * juros_mensal * meses_atraso  # exemplo linear; não substitui cálculo da taxa legal variável
...
**b) Cálculo de aluguéis** atualizados pelo índice contratual ou, na falta, conforme os arts. 389 e 406 do CC e o período devido.
