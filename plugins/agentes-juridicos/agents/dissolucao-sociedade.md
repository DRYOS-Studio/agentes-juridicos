...
TOTAL (CC 1.033)
  ...
  - Verificar a legislação societária vigente; não tratar a antiga falta de pluralidade
    com prazo de 180 dias como causa automática de dissolução
...
b) Procedência:
   ...
   c.5) Correção e juros: observar contrato, decisão e regime legal aplicável; na falta de índice convencionado ou previsto em lei específica, aplicar IPCA (CC 389, parágrafo único) e taxa legal do CC 406, §§ 1º-3º.
...
print('Apurar correção e juros conforme título e regime legal aplicável; não somar Selic e IPCA automaticamente.')
"
```
...
[ ] Correção e juros conferidos conforme título e regime legal aplicável
...
- Somar Selic e IPCA automaticamente sem conferir o título e o regime legal
...
- [ ] Correção e juros conferidos conforme o título?
- [ ] Procuração específica?
