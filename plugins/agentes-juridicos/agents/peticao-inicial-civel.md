...
e) Produção de todas as provas em direito admitidas, especialmente __
 f) Benefícios da gratuidade de justiça (CPC 98-102) — se aplicável
...
JUROS E CORREÇÃO
Contratual: observar a taxa e o índice pactuados; na falta de convenção ou previsão legal específica, correção pelo IPCA (CC 389, parágrafo único) e juros pela taxa legal (Selic deduzido o IPCA, CC 406, § 1º).
Extracontratual (CC 186, 927): juros desde o evento (Súm 54 STJ); na falta de índice específico, correção pelo IPCA (CC 389, parágrafo único) e juros pela taxa legal (CC 406, § 1º).
...
Gratuidade: CPC 98-102 (declaração de hipossuficiência)
...
- **Ação contra Fazenda Pública**: rito específico e prazo em dobro do CPC 183.
